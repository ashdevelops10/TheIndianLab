    ...
    <section className="section-cream relative overflow-hidden py-[clamp(4rem,8vw,7rem)]">
      <Container className="grid items-center gap-8 md:grid-cols-12 md:gap-x-10 lg:gap-x-14">
        ...
        <div className="relative md:col-span-5">
          ...
          />
          {/* floating logo badge */}
          <div className="absolute -bottom-6 right-4 grid h-32 w-32 place-items-center rounded-full border border-accent-bordeaux/30 bg-bg-cream shadow-[0_24px_60px_-30px_rgba(75,19,17,0.5)] md:h-28 md:w-28">
            <div
              className="h-[52px] w-[64px] md:h-[54px] md:w-[70px]"
              style={{
