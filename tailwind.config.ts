...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        "fluid-display": ["clamp(3.5rem, 11vw, 11rem)", { lineHeight: "1.0", letterSpacing: "0.06em" }],
        "fluid-hero": ["clamp(2.5rem, 8.5vw, 7rem)", { lineHeight: "1.05", letterSpacing: "0.04em" }],
        "fluid-h1": ["clamp(2.25rem, 7vw, 6rem)", { lineHeight: "1.08", letterSpacing: "0.03em" }],
        "fluid-h2": ["clamp(1.875rem, 5.2vw, 4.25rem)", { lineHeight: "1.1", letterSpacing: "0.025em" }],
        "fluid-h3": ["clamp(1.5rem, 3vw, 2.25rem)", { lineHeight: "1.2", letterSpacing: "0.02em" }],
