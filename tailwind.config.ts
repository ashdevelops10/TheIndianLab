...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        "fluid-display": ["clamp(4rem, 13vw, 13rem)", { lineHeight: "0.86", letterSpacing: "-0.03em" }],
        "fluid-hero": ["clamp(3rem, 10vw, 8.5rem)", { lineHeight: "0.88", letterSpacing: "-0.025em" }],
        "fluid-h1": ["clamp(2.85rem, 9vw, 7.5rem)", { lineHeight: "0.9", letterSpacing: "-0.02em" }],
        "fluid-h2": ["clamp(2.6rem, 6.8vw, 5.5rem)", { lineHeight: "0.93", letterSpacing: "-0.018em" }],
        "fluid-h3": ["clamp(1.85rem, 3.6vw, 2.75rem)", { lineHeight: "1.05", letterSpacing: "-0.01em" }],
